...
export default function BoothsPage() {
  const { data: booths = [], loading, errorMessage, refetch } = useAsyncData(boothApi.getAll);
  ...
  return (
    <MobileShell title="การเข้าร้าน / บูธ" backHref="/">
      <section className="booths-screen paper-texture">
        ...
        {loading ? <LoadingState label="กำลังโหลดรายชื่อบูธ" /> : errorMessage ? (
